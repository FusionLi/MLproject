...
feature_3 = "total_payments" # optional
poi  = "poi"
...
try:
    Draw(pred, finance_features, poi, mark_poi=False, name="clusters_without_feature_scaling.pdf", f1_name=feature_1, f2_name=feature_2)
except NameError:
...
clf = KMeans(n_clusters = 2)
clf.fit(scaled_finance_features)
pred = clf.predict(scaled_finance_features)
